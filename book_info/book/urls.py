...
urlpatterns = [
    ...
    path('book/<slug:slug>/', views.InfoCard.as_view(), {'list_type': 'book'},
         name='book'),
    path('book_list/', views.TotalList.as_view(), {'list_type': 'book_list'},
         name='book_list'),
    path('author_list/', views.TotalList.as_view(), {'list_type': 'author_list'},
         name='author_list'),
    path('genre_list/', views.TotalList.as_view(), {'list_type': 'genre_list'},
         name='genre_list'),
